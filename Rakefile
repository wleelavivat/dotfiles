...
task :install => [:submodule_init, :submodules] do
  ...
  # file_operation(Dir.glob('bash/*')) if want_to_install?('bash configs')
  # file_operation(Dir.glob('XApp/*')) if want_to_install?('X Application configs')
  ...
  file_operation(Dir.glob('editorconfig/*')) if want_to_install?('editorconfig setting')
...
def install_fonts
  ...
  puts "======================================================"
  run %{ cp -rf $HOME/.dotfiles/fonts/* $HOME/Library/Fonts }
  puts
end
...
def install_prezto
  ...
  run %{ git clone --recursive https://github.com/sorin-ionescu/prezto.git "$HOME/.dotfiles/zsh/prezto" }
  run %{ ln -nfs "$HOME/.dotfiles/zsh/prezto" "${ZDOTDIR:-$HOME}/.zprezto" }

  # The prezto runcoms are only going to be installed if zprezto has never been installed
  run %{ rm -f "${ZDOTDIR:-$HOME}/.zpreztorc" }
